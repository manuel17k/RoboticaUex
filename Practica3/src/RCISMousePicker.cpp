...
RoboCompRCISMousePicker::RCISMousePicker::_iceD_setPick(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    ::RoboCompRCISMousePicker::Pick iceP_myPick;
...
void
RoboCompRCISMousePicker::RCISMousePickerPrx::_iceI_setPick(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::RoboCompRCISMousePicker::Pick& iceP_myPick, const ::Ice::Context& context)
{
...
void
::IceProxy::RoboCompRCISMousePicker::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< ::IceProxy::RoboCompRCISMousePicker::RCISMousePicker>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
RoboCompRCISMousePicker::RCISMousePicker::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ...
    Ice::StreamWriter< ::RoboCompRCISMousePicker::RCISMousePicker, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    Ice::StreamReader< ::RoboCompRCISMousePicker::RCISMousePicker, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
