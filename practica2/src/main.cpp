...
/** \mainpage RoboComp::firstcomp
 *
 * \section intro_sec Introduction
 *
 * The firstcomp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/firstcomp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class firstcomp : public RoboComp::Application
{
public:
	firstcomp (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
